...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed2_LimitedSame() {
	...
	s.placeBidBatchWorth(auction.Id, s.addr(3), parseDec("0.8"), parseCoin("300_000_000denom2"), sdk.NewInt(0), true)
	s.placeBidBatchWorth(auction.Id, s.addr(7), parseDec("0.6"), parseCoin("500_000_000denom2"), sdk.NewInt(700_000_000), true)
	...
	MatchedAmt7 := sdk.NewInt(700_000_000)
	MatchedAmt8 := sdk.NewInt(500_000_000)
	MatchedAmt9 := sdk.NewInt(600_000_000)
	MatchedAmt10 := sdk.NewInt(100_000_000)

	TotalMatchedAmt := sdk.NewInt(4400_000_000)
	...
	ReservedMatchedAmt7 := sdk.NewInt(420_000_000)
	...
	RefundAmt3 := sdk.NewInt(1130_000_000)
	RefundAmt4 := sdk.NewInt(20_000_000)
	RefundAmt5 := sdk.NewInt(180_000_000)
	RefundAmt6 := sdk.NewInt(550_000_000)
	RefundAmt7 := sdk.NewInt(80_000_000)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed2_LimitedDifferent() {
	...
	s.placeBidBatchWorth(auction.Id, s.addr(3), parseDec("0.8"), parseCoin("300_000_000denom2"), sdk.NewInt(0), true)
	s.placeBidBatchWorth(auction.Id, s.addr(7), parseDec("0.6"), parseCoin("500_000_000denom2"), sdk.NewInt(400_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(8), parseDec("0.8"), parseCoin("500_000_000denom1"), sdk.NewInt(400_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(9), parseDec("0.6"), parseCoin("600_000_000denom1"), sdk.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.Id, s.addr(6), parseDec("0.5"), parseCoin("500_000_000denom2"), sdk.NewInt(0), true)
	...
	RefundAmt3 := sdk.NewInt(1150_000_000)
	RefundAmt4 := sdk.NewInt(30_000_000)
	RefundAmt5 := sdk.NewInt(210_000_000)
	RefundAmt6 := sdk.NewInt(250_000_000)
	RefundAmt7 := sdk.NewInt(300_000_000)
	RefundAmt8 := sdk.NewInt(200_000_000)
	RefundAmt9 := sdk.NewInt(260_000_000)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed3_LimitedDifferent() {
	...
	s.placeBidBatchMany(auction.Id, s.addr(5), parseDec("10.8"), parseCoin("300_000_000denom1"), sdk.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.Id, s.addr(6), parseDec("11.4"), parseCoin("2500_000_000denom2"), sdk.NewInt(200_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(7), parseDec("11.3"), parseCoin("100_000_000denom1"), sdk.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.Id, s.addr(8), parseDec("9.9"), parseCoin("2500_000_000denom2"), sdk.NewInt(200_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(9), parseDec("10.1"), parseCoin("300_000_000denom1"), sdk.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.Id, s.addr(10), parseDec("10.45"), parseCoin("2000_000_000denom2"), sdk.NewInt(200_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(11), parseDec("10.75"), parseCoin("150_000_000denom1"), sdk.NewInt(100_000_000), true)
	s.placeBidBatchWorth(auction.Id, s.addr(12), parseDec("10.99"), parseCoin("1500_000_000denom2"), sdk.NewInt(100_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(13), parseDec("10.2"), parseCoin("200_000_000denom1"), sdk.NewInt(100_000_000), true)
	s.placeBidBatchWorth(auction.Id, s.addr(14), parseDec("9.87"), parseCoin("2000_000_000denom2"), sdk.NewInt(100_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(15), parseDec("10.25"), parseCoin("200_000_000denom1"), sdk.NewInt(100_000_000), true)
	s.placeBidBatchWorth(auction.Id, s.addr(16), parseDec("10.48"), parseCoin("2500_000_000denom2"), sdk.NewInt(100_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(17), parseDec("10.52"), parseCoin("180_000_000denom1"), sdk.NewInt(100_000_000), true)
	s.placeBidBatchMany(auction.Id, s.addr(4), parseDec("10.8"), parseCoin("220_000_000denom1"), sdk.NewInt(0), true)
	s.placeBidBatchWorth(auction.Id, s.addr(5), parseDec("10.5"), parseCoin("1500_000_000denom2"), sdk.NewInt(0), true)
	s.placeBidBatchMany(auction.Id, s.addr(6), parseDec("9.7"), parseCoin("250_000_000denom1"), sdk.NewInt(0), true)
	...
	MatchedAmt16 := sdk.NewInt(100_000_000)
	...
	ReservedMatchedAmt6 := MatchedAmt6.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	ReservedMatchedAmt7 := MatchedAmt7.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	ReservedMatchedAmt8 := sdk.NewInt(0)
	ReservedMatchedAmt9 := MatchedAmt9.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	ReservedMatchedAmt10 := sdk.NewInt(2000_000_000)
	ReservedMatchedAmt11 := MatchedAmt11.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	ReservedMatchedAmt12 := MatchedAmt12.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	ReservedMatchedAmt13 := MatchedAmt13.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	ReservedMatchedAmt14 := sdk.NewInt(0)
	ReservedMatchedAmt15 := MatchedAmt15.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	ReservedMatchedAmt16 := MatchedAmt16.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	ReservedMatchedAmt17 := MatchedAmt17.ToDec().Mul(matchingPrice).Ceil().TruncateInt()
	...
	RefundAmt7 := sdk.NewInt(100_000_000).ToDec().Mul(parseDec("11.3")).Ceil().TruncateInt().Sub(ReservedMatchedAmt7)
	RefundAmt8 := sdk.NewInt(2500_000_000)
	RefundAmt9 := sdk.NewInt(300_000_000).ToDec().Mul(parseDec("10.1")).Ceil().TruncateInt().Sub(ReservedMatchedAmt9)
	RefundAmt10 := sdk.NewInt(2000_000_000).Sub(ReservedMatchedAmt10)
	RefundAmt11 := sdk.NewInt(150_000_000).ToDec().Mul(parseDec("10.75")).Ceil().TruncateInt().Sub(ReservedMatchedAmt11)
	RefundAmt12 := sdk.NewInt(1500_000_000).Sub(ReservedMatchedAmt12)
	RefundAmt13 := sdk.NewInt(200_000_000).ToDec().Mul(parseDec("10.2")).Ceil().TruncateInt().Sub(ReservedMatchedAmt13)
	RefundAmt14 := sdk.NewInt(2000_000_000)
	RefundAmt15 := sdk.NewInt(200_000_000).ToDec().Mul(parseDec("10.25")).Ceil().TruncateInt().Sub(ReservedMatchedAmt15)
	RefundAmt16 := sdk.NewInt(2500_000_000).Sub(ReservedMatchedAmt16)
	RefundAmt17 := sdk.NewInt(180_000_000).ToDec().Mul(parseDec("10.52")).Ceil().TruncateInt().Sub(ReservedMatchedAmt17)
