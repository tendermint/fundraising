...
var (
	...
	ErrIncorrectOwner              = sdkerrors.Register(ModuleName, 9, "incorrect owner")
	ErrEmptyAllowedBidders         = sdkerrors.Register(ModuleName, 10, "empty bidders")
	ErrNotAllowedBidder            = sdkerrors.Register(ModuleName, 11, "not allowed bidder")
	ErrOverMaxBidAmountLimit       = sdkerrors.Register(ModuleName, 12, "over maximum bid amount limit")
	ErrInsufficientRemainingAmount = sdkerrors.Register(ModuleName, 13, "insufficient remaining amount")
	ErrInsufficientMinBidPrice     = sdkerrors.Register(ModuleName, 14, "insufficient minimum bid price")
)
