...
// BatAuction defines a batch auction type. It allows each bidder
// to participate in the auction by placing limit orders with a bid price
// chosen freely at any time within the auction period. An order book is created
// to record the bids with various bid prices.
type BatchAuction struct {
	*BaseAuction `protobuf:"bytes,1,opt,name=base_auction,json=baseAuction,proto3,embedded=base_auction" json:"base_auction,omitempty"`
	...
	// rate_extended_round specifies the rate that decides if the auction needs
	// another round
	RateExtendedRound github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=rate_extended_round,json=rateExtendedRound,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"rate_extended_round"`
}
...
var fileDescriptor_a97a388085f27061 = []byte{
	...
	,
}
...
func (m *BatchAuction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.RateExtendedRound.Size()
		i -= size
		if _, err := m.RateExtendedRound.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintFundraising(dAtA, i, uint64(size))
	}
...
func (m *BatchAuction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RateExtendedRound", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RateExtendedRound.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
