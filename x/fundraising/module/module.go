...
import (
	...
	modulev1 "github.com/tendermint/fundraising/api/fundraising/fundraising/module/v1"
...
type ModuleOutputs struct {
	...
	FundraisingKeeper keeper.Keeper
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{FundraisingKeeper: k, Module: m}
}

func InvokeSetHooks(keeper *keeper.Keeper, hooks map[string]types.FundraisingHooks) error {
	...
	var multiHooks types.MultiFundraisingHooks
