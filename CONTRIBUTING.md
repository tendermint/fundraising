...
Before you create a PR on the fundraising module, make sure that you read and comply with this document. See the [open issues](https://github.com/tendermint/fundraising/issues) that we need help with. 
